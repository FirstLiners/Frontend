      ...
      const WebGLRenderingContextHandler = {
        get: (target, propName) =>
          'string' == typeof propName
            ? 'function' != typeof ctx[propName]
              ? ctx[propName]
              : (...args) => callMethod(ctxInstance, [propName], args, getWebGlMethodCallType(propName))
            : target[propName],
        set(target, propName, value) {
          if ('string' == typeof propName && propName in ctx) {
            ctx[propName] !== value && 'function' != typeof value && setter(ctxInstance, [propName], value);
    ...
    const WorkerAudioTrackList = class {
      constructor(mediaElm) {
        ...
        return new Proxy(instance, {
          get: (target, propName) =>
            'number' == typeof propName ? new WorkerAudioTrack(winId, instanceId, ['audioTracks', propName]) : target[propName],
        });
      }
    };

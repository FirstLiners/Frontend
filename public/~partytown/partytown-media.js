      ...
      const r = {
        ...
        p = (e, t, r) => {
          const i = e[o],
            ...
            g = 'getContextAttributes,getImageData,getLineDash,getTransform,isPointInPath,isPointInStroke,measureText'.split(','),
            l = {
              get: (e, t) =>
                'string' == typeof t && t in p
                        ...
                        if (t.startsWith('create')) {
                          ...
                          return (
                            ...
                            'createImageData' === t || 'createPattern' === t
                              ? ((s = `${t}()`), console.warn(`${s} not implemented`), { setTransform: () => {} })
                              : new h(i, r)
                          );
                        }
                        var s;
                  ...
                  : e[t],
              set: (e, t, n) => (
                'string' == typeof t && t in p ? (p[t] !== n && 'function' != typeof n && s(f, [t], n), (p[t] = n)) : (e[t] = n),
                !0
              ),
            };
        ...
        g = (e, t, r) => {
          const i = e[o],
            ...
            p = {
              get: (e, t) => ('string' == typeof t ? ('function' != typeof f[t] ? f[t] : (...e) => n(h, [t], e, m(t))) : e[t]),
              set: (e, t, n) => (
                'string' == typeof t && t in f ? (f[t] !== n && 'function' != typeof n && s(h, [t], n), (f[t] = n)) : (e[t] = n),
                !0
              ),
            };
        ...
        m = (e) => (e.startsWith('create') || e.startsWith('get') || e.startsWith('is') || l.includes(e) ? 1 : 2);

...
((e) => {
  const t = () => {},
    ...
    n = (e) => {
      var t, r, n;
      try {
        const r = null === (t = null == e ? void 0 : e.constructor) || void 0 === t ? void 0 : t.name;
        if (r) return r;
      } catch (e) {}
      try {
        const t =
          null ===
            (n =
              null === (r = null == e ? void 0 : e.__zone_symbol__originalInstance) || void 0 === r ? void 0 : r.constructor) ||
          void 0 === n
            ? void 0
            : n.name;
        if (t) return t;
    ...
    s = (e) => !(i(e, 'webkit') || i(e, 'toJSON') || i(e, 'constructor') || i(e, 'toString') || i(e, '_')),
  ...
  const $ = e.parent,
    ...
    T = (e, t, r) => {
      const n = ((e, t) => {
        return (r = e), (n = { value: t }), Object.defineProperty(r, 'name', { ...n, configurable: !0 });
        var r, n;
      })(class extends m[e].U.HTMLElement {}, r[0]);
      return (
        'connectedCallback,disconnectedCallback,attributeChangedCallback,adoptedCallback'.split(',').map(
          (r) =>
      ...
      if (((a = {}), !r.has(t)))
        for (l in (r.add(t), t))
          s(l) &&
            ...
            (i || 'function' != typeof c) && (o || '' !== c) && (a[l] = I(e, c, r)));
      return a;
    },
    x = (e) => {
      let t,
    ...
    W = 'cssText,selectorText,href,media,namespaceURI,prefix,name,conditionText'.split(','),
    U = async (e, t) => {
      let n,
        i,
        s,
          ...
          (l = d === u - 1),
            ...
            1 === s[0] && s[1] in m[i].U
              ...
              : ((o = y(i, n.w)),
                o
                  ? ((a = P(e, i, o, s, l, n.r)),
                    n.d && ('string' == typeof n.d ? v(a, n.d) : (m[n.d.V] = { V: n.d.V, U: { document: a } })),
                    'object' == typeof (h = a) && h && h.then && ((a = await a), l && (c.z = !0)),
          ...
          if (!Array.isArray(l))
            if ('string' == typeof c || 'number' == typeof c) {
              ...
              if (
                'function' == typeof i[u] &&
                ((d = L(e, c)),
                'define' === u && 'CustomElementRegistry' === n(i) && (d[1] = T(t, e, d[1])),
    ...
    j = (e, t) => {
      let n,
        ...
        l = a.document;
      l && l.body
        ? ((n = l.querySelector('script[type="text/partytown"]:not([data-ptid]):not([data-pterror]):not([async]):not([defer])')),
          n || (n = l.querySelector('script[type="text/partytown"]:not([data-ptid]):not([data-pterror])')),
          n
            ...
            : (t.x ||
                ...
                ((e, t, n) => {
                  let i,
                    ...
                    l = (r, n) => e.postMessage([10, { V: t, q: r, b: I(t, Array.from(n)) }]);
                  if (
                    ((n._ptf = void 0),
                    a.map((e) => {
                      (s = n),
                        e.split('.').map((e, t, n) => {
                          s = s[n[t]] = t + 1 < r(n) ? s[n[t]] || ('push' === n[t + 1] ? [] : {}) : (...e) => l(n, e);
                        });
                    }),
                    o)
                  )
          ...
          ((e, t, r, n) => {
            if ((r = t.match(/^(HTML|SVG)(.+)Element$/)))
              return (
                (n = r[2]),
                'S' == t[0]
                  ? e.createElementNS('http://www.w3.org/2000/svg', c[n] || n.slice(0, 2).toLowerCase() + n.slice(2))
      ...
      try {
        s(r) &&
          ...
          ('function' == (o = typeof (i = t[r]))
            ...
            : 'object' === o && null != i
              ? 'Object' !== (a = n(i)) && 'Function' !== a && self[a] && e.push([r, i.nodeType || a])
  ...
  (async (e) => {
    ...
    return (n, i) => {
      ...
      if (0 === s) {
        const e = (() => {
          ...
          return (
            ((e, t, r) => {
              void 0 !== t[r] && e.push([r, 'Object', Object.keys(t[r].prototype).map((e) => [e, 6]), 12]);
    ...
    e &&
      ...
      $.addEventListener('pt1', (e) => H(J, f(e.detail.frameElement), e.detail)));
  });
})(window);

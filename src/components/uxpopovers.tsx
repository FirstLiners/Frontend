...
import Cross from "../shared/cross.svg"; // used for the close button as backgroundImage and this does not work
    ...
    steps: [
      {
        title: (
          <div className="flex justify-between">
            <div className="object-left">
              <h1 className="object-left ml-2  text-stone-950 text-start text-[24px]">Load error</h1>{" "}
            </div>
        ...
        content: (
          <div>
            <h2 className="object-left left-0  text-stone-950 text-start">Load error</h2>
            <p className="text-[12px] text-gray-400">{String((err as any).downloadError.config.params.filename)}</p>
            <progress className="object-left left-0 progress progress-error w-168" value="100" max="100"></progress>
          </div>
        ),
        locale: {

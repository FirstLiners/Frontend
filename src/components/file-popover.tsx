        ...
        {distinguishResponse(arg) === 'OK' ? (
          <>
            {percent < 100 ? (
              ...
              <progress className="w-168 progress progress-success left-0 object-left" value={100} max={100} />
            )}
          </>
        ) : (
          <progress className="w-168 progress progress-error left-0 object-left" value={100} max={100} />
        )}
      </div>
    </div>
  );

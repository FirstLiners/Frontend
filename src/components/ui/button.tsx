  ...
  'inline-flex items-center rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        ...
        outline: 'border border-input w-[200px] left-0.5 bg-background hover:bg-accent hover:text-accent-foreground',
        secondary: 'text-[#003C96] border justify-center rounded-xl ml-6 w-[156px] hover:bg-secondary/80',
        firstly: 'bg-[#003C96] text-white justify-center rounded-xl ml-6 w-[156px] hover:bg-[#001E64]/90',
        dropdownMenuButton1: 'bg-[#003C96] text-white justify-center rounded-lg w-[88px] h-[32px] text-xs hover:bg-[#001E64]/90',
        dropdownMenuButton2:
        ...
        excel: 'bg-white text-[#003C96] justify-center rounded-xl border w-[170px] hover:bg-secondary/80',
